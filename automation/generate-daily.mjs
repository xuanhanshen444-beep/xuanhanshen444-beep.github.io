...
const MIN_NEWS_ITEMS = Number(process.env.MIN_NEWS_ITEMS || 18);
...
const researchGroups = [
  {
    ...
    maxItems: 22,
    focus: "各国电动车、电池、关键矿产政策及贸易措施；镍、钴、锂矿山、冶炼、资源交易、产能和供应事件；以及有署名、有原文、有论据的政策或资源市场分析。优先政府原文、SMM、Reuters及公司公告。政策需充分覆盖中国、美国、欧盟、日韩、东南亚、印度和至少一个资源地区；上游事实动态通常不超过3条，但可加入少量能解释供需、政策执行或价格机制的独立行业观点。",
  },
  {
    name: "正极与电池",
    segments: ["正极与前驱体", "电池与装机"],
    maxItems: 24,
    focus: "瑞翔、EcoPro及主要正极/前驱体厂商的订单、合作、投扩产和客户认证；电池厂供货、装机、工厂、技术量产和行业数据；以及有署名、有数据或产业访谈依据的技术路线、排产、库存和需求分析。优先SMM、中国汽车动力电池产业创新联盟、公司公告、Reuters和指定公众号原文；同时检索海外电池厂、欧洲/北美本地化产能、日韩正极/电池供应链和中国企业出海项目。",
  },
  {
    name: "终端电车",
    segments: ["终端电车"],
    maxItems: 30,
    focus: "广泛检索具体车企的新车型、交付、产销、工厂、供应商、召回、出口、充换电合作和市场进入退出，并纳入有署名、有原文、有依据的车型竞争、渠道反馈、需求变化和车企策略分析。优先Reuters、盖世汽车、中汽协、车企、政府公告和指定公众号原文；终端电车是本简报重点。必须主动检索海外车企与中国车企海外市场动态，包括美国、欧洲、东南亚、拉美和中东市场。观点必须明确标注，不能替代事实核验。完全排除储能项目新闻。",
  },
];
...
硬性要求：
1. 严格覆盖上述增量窗口。扩大候选池，正常一期整体目标18-35条内容，公众号草稿正常需达到15条以上，其中可有4-10条行业观点；这是研究深度目标，不能靠重复、传闻或空话凑数。本轮最多${group.maxItems}条。
...
6. 优先SMM、Reuters、盖世汽车、中国汽车动力电池产业创新联盟、中汽协、政府/监管机构、公司新闻稿、交易所公告。海外检索还需覆盖CnEVPost、Electrive、InsideEVs、海外政府/监管机构和公司官网。重大事件尽量用第二来源交叉核实。
